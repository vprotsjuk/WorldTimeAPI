...
public class UnixTimeTest {
    ...
    void checkUnixtime() throws IOException {
        long realUnixTime = System.currentTimeMillis() / 1000L;
        ...
        sa.assertTrue(timezoneAreaDTO.unixtime/10 == realUnixTime/10);
        System.out.println(timezoneAreaDTO.unixtime/10);
        System.out.println(realUnixTime/10);
        sa.assertAll();
    }
